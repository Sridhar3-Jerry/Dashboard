...
function Aside({visible,setVisible}){
    ...
    return(
        ...
        className="w-1/3">
            <div className="border-l border-gray-300 h-screen">
                <div className="p-3">
                    ...
                    <div className="rounded-2xl flex flex-col items-center justify-center text-center bg-gray-200 p-16 ">
                        <div>
                        ...
                        <div className="flex justify-around w-2/3 p-2 pt-6">
                            <Phone size={38} className="bg-white rounded-full p-1"/>
                            <Video size={38} className="bg-white rounded-full p-1"/>
                            <EllipsisVertical size={38} className="bg-white rounded-full p-1"/>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className=" flex justify-end p-3">
                                <div className="w-1/2 bg-blue-100 p-3 rounded-2xl"> <p>Hi! Next week we'll start a new project. I'll tell you all the details later</p> </div>
                        </div>
                    </div>
                    <div>
                        ...
                        <div className=" flex justify-end p-3">
                                <div className="w-1/2 bg-blue-100 p-3 rounded-2xl flex gap-2 items-center justify-between"> 
                                    <div className="flex gap-3">
                                        ...
                                        <div>
                                            <p>Homepage.fig</p>
                                            <p className="text-sm text-gray-400">13.4 Mb</p>
                                        </div>
                                    </div>
                                    <CircleArrowDown className="text-blue-500"></CircleArrowDown>
                                </div>
                        </div>
                    </div>
                    <div>
                    ...
                    <div className="pt-10">
                        <div className="flex items-center  w-full bg-gray-100 rounded-xl justify-between px-12 p-1">
                            <div className="flex items-center gap-2">
                                <FiPaperclip size={24} className="text-gray-500 cursor-pointer"/>
                                <input type="text" placeholder="Write a message" className="p-3 text-xl outline-none focus:outline-none focus:ring-0 border-none"/>
                            </div>
